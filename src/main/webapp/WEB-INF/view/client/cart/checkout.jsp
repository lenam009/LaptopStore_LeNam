    ...
    <body>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <h1 class="text-danger"><c:if test="${empty cartDetails}"> Giỏ hàng rỗng </c:if></h1>
            </div>
                            ...
                            <tbody>
                                <c:forEach var="cartDetail" items="${cartDetails}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/product/${cartDetail.getProduct().id}" target="_blank" class="mb-0 mt-5"
                                                >${cartDetail.product.getName()}</a
                                            >
                                        </td>
                                        <td>
                                            <p class="mb-0 mt-4"><fmt:formatNumber type="number" value="${cartDetail.product.getPrice()}" /> đ</p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <p class="mb-0 mt-4" data-cart-detail-id="${cartDetail.id}">
                                                <fmt:formatNumber type="number" value="${cartDetail.getProduct().getPrice() * cartDetail.quantity}" />
                                                đ
                                            </p>
                                        </td>
                                        <td>
